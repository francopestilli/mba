function [finalResNifti, resample_params] = mbaResampleToNifti (originalResNifti, finalResNifti,fname,resample_params)
% Resample a nifti file to the resoltuion fo a second nifti file.
%
%   [finalResNifti, resample_params] = ...
%    mbaResampleToNifti(originalResNifti,finalResNifti,[fname],[resample_params])
%
% INPUTS:
...
%   res              = mbaResampleToNifti(originalResNifti, finalResNifti,fname)
%
%   % Up sample
%   basedir = mrvDataRootPath;
...
finalResNifti.data = mbaReslice(double(originalResNifti.data), ...
