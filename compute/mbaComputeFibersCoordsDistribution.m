function [SuperFiber, weights] = mbaComputeFibersCoordsDistribution(fg, numberOfNodes, M)
% 
% Represent fiber group as a 3d gaussian
%
% [SuperFiber, weights] = mbaComputeFibersCoordsDistribution(fg,[numberOfNodes=30],[M='mean'])
% 
% INPUTS:
