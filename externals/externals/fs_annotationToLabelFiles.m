function cmd = fs_annotationToLabelFiles(fs_subject,annotationFileName,hemisphere,labelsDir,regMgzFile)
%
...
%
%  cmd = fs_annotationToLabelFiles(fs_subject,[annotationFileName],[hemisphere],[labelsDir],[regMgzFile])
%
% 
% INPUTS:
...
%                           (Generally these files are created during the
%                           segmentation and parcellation process of
%                           FreeSurfer and are stored under:
...
%      labelsDir     - Optional. This is the full path to the directory
%                      where the .labels files will be saved. By default we
%                      save into: $SUBJECTS_DIR/<this_subject>/label/
%                      I suggest you do not change this, so that your
%                      labels will be compatible with FreeSurfer.
