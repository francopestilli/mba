...
% We now load the nifti just created and fill any hole left in the voxels.
% These holes are generally found when transforming from FreeSurfer to
% nifti's. I am not sure why this happens. The solution here is to fill the
% holes.
...
% Write out the preprocessed nifti file
niftiWrite(niftiRoi);
